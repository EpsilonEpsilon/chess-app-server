...
class App{
    ...
    private initRoutes(){
        this.app.use("/docs", swaggerUi.serve ,swaggerUi.setup(openapiSpecification, {customCssUrl:"https://cdnjs.cloudflare.com/ajax/libs/swagger-ui/4.1.0/swagger-ui.min.css"}))
